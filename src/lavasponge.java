...
public class lavasponge extends JavaPlugin {
	...
	public void init(){
		...
		enableWater = Settings.getBoolean("EnableWaterSponge", false);
		enableLava = Settings.getBoolean("EnableLavaSponge", false);
		radius = Math.max(1, Settings.getInt("SpongeRadius",3)) - 1;
	}
	static{
